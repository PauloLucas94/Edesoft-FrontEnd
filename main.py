...
frame_direita.grid(row=0, column=1, rowspan=2, padx=1, pady=1, sticky=NSEW)
...
#sobre
l_assunto = Label(frame_baixo, text= 'Observações', anchor=NW, font=('Ivy 10 bold'), bg=co1, fg=co4, relief='flat')
...
#botão deletar
b_del = Button(frame_baixo, command=deletar, text= 'Deletar', width=10, font=('Ivy 9 bold'), bg=co7, fg=co1, relief='raised', overrelief='ridge')
b_del.place(x=195, y=340)
